...
void cgi_task_queue_put(cgi_thread_pool_t *pool, void* (*callback)(void*), void *arg)
{
	pthread_mutex_lock(&pool->mutex);
...
void cgi_task_queue_push(cgi_task_queue_t **head_ptr, void* (*callback)(void*), void *arg)
{
